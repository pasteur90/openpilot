...
CHECKSUM = {
  ...
  "7B": [CAR.KIA_STINGER, CAR.ELANTRA, CAR.KIA_OPTIMA, CAR.GENESIS_G90, CAR.GENESIS_G80, CAR.IONIQ, CAR.I30],
}

FEATURES = {
  "use_cluster_gears": [CAR.ELANTRA, CAR.I30],                   # Use Cluster for Gear Selection, rather than Transmission
